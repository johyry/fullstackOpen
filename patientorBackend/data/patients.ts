import { PatinentEntry, Gender } from "../src/types/types";
import toNewPatientEntry from "../src/utils";

const patients: PatinentEntry[] = [
    {
...
const patientEntries: PatinentEntry[] = patients.map(obj => {
  console.log(patients[0]);
    const object = toNewPatientEntry(obj) as PatinentEntry;
    object.id = obj.id;
    return object;
});
